...
- Parser hiện là baseline `pypdf`, trả structured `parsed-cv/1.0` tối thiểu cho PDF có text; OCR, chỉnh sửa ParsedCV, Job, Application và matching chưa hoàn thiện.
